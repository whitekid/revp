...
const (
	Revp_Stream_FullMethodName = "/api.v1alpha1.revp.Revp/Stream"
)
...
func (c *revpClient) Stream(ctx context.Context, opts ...grpc.CallOption) (Revp_StreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &Revp_ServiceDesc.Streams[0], Revp_Stream_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
var Revp_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.v1alpha1.revp.Revp",
...
const (
	StreamExample_ClientStream_FullMethodName        = "/api.v1alpha1.revp.StreamExample/ClientStream"
	StreamExample_ServerStream_FullMethodName        = "/api.v1alpha1.revp.StreamExample/ServerStream"
	StreamExample_BidirectionalStream_FullMethodName = "/api.v1alpha1.revp.StreamExample/BidirectionalStream"
)
...
func (c *streamExampleClient) ClientStream(ctx context.Context, opts ...grpc.CallOption) (StreamExample_ClientStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &StreamExample_ServiceDesc.Streams[0], StreamExample_ClientStream_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *streamExampleClient) ServerStream(ctx context.Context, in *StreamReq, opts ...grpc.CallOption) (StreamExample_ServerStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &StreamExample_ServiceDesc.Streams[1], StreamExample_ServerStream_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *streamExampleClient) BidirectionalStream(ctx context.Context, opts ...grpc.CallOption) (StreamExample_BidirectionalStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &StreamExample_ServiceDesc.Streams[2], StreamExample_BidirectionalStream_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
var StreamExample_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.v1alpha1.revp.StreamExample",
...
const (
	Greeter_SayHello_FullMethodName = "/api.v1alpha1.revp.Greeter/SayHello"
)
...
var Greeter_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.v1alpha1.revp.Greeter",
